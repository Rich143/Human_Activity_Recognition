...
#define LOAD_IMU_DATA_FROM_FILE_NAME        "Recorded_Data/WALKING_OCT_21_RICHARD_input.h"
#define LOAD_IMU_DATA_FROM_FILE_NUM_SAMPLES WALKING_OCT_21_RICHARD_INPUT_LEN
#define LOAD_IMU_DATA_FROM_FILE_X_DATA      WALKING_OCT_21_RICHARD_input_x
#define LOAD_IMU_DATA_FROM_FILE_Y_DATA      WALKING_OCT_21_RICHARD_input_y
#define LOAD_IMU_DATA_FROM_FILE_Z_DATA      WALKING_OCT_21_RICHARD_input_z

#define LOG_PRINT_CSV_INCLUDE_MODEL_OUTPUT 0

#define CONFIG_LOGGING_ENABLED_DEFAULT 0
