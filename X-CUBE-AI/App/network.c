...
#define AI_NETWORK_MODEL_SIGNATURE     "2d4c2f050910fec0492dae6052eaf08d"
...
#define AI_TOOLS_DATE_TIME   "Wed Jul 16 20:03:19 2025"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 288);
    conv2d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 288);
    
    activation_output_array.data = AI_PTR(g_network_activations_map[0] + 288);
    activation_output_array.data_start = AI_PTR(g_network_activations_map[0] + 288);
    
    max_pooling2d_output_array.data = AI_PTR(g_network_activations_map[0] + 288);
    max_pooling2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 288);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 1536);
    conv2d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1536);
    
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 1632);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1632);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 12000);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 12000);
